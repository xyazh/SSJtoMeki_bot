...
#                 self.server.groupBan(self.group_id,qqid,sec)
    ...
    def nowTime(self, data):
        ...
        if get_msg in ("当前时间", "时间"):
            ...
            # 平常
            a = r"现在是？……【%Y-%m-%d，%H:%M:%S】的说……嗯……应该没搞错吧……"
            b = r"【%Y-%m-%d，%H:%M:%S】的说……自己也可以看为什么要来问像我这样的人呢……"
            c = r"【%Y-%m-%d，%H:%M:%S】……希望不会发生什么不好的事就好了……"
            d = r"【%Y-%m-%d，%H:%M:%S】了呢，感觉好闲呢……吖呜（打哈欠），都不知道该干什么了……(￣▽￣)"
            e = r"【%Y-%m-%d，%H:%M:%S】的说，这个时间段大家在做什么呢？Ciallo～(∠·ω< )⌒☆"
            # 凌晨 00.00-05.00
            f = r"啊~~~哈~~~呜~~~【%Y-%m-%d，%H:%M:%S】，都这么晚了……大家都不睡觉嘛……(´·ω·`)？"
            g = r"【%Y-%m-%d，%H:%M:%S】，嗷~~~好困的说……嗯嗯呃呃……"
            h = r"喵呜~~~【%Y-%m-%d，%H:%M:%S】，该睡觉了的说……"
            # 早晨 05.00-08.00
            i = r"【%Y-%m-%d，%H:%M:%S】？好困啊……起床……不要……"
            j = r"(＠￣￢￣＠)zzZ，现在是……【%Y-%m-%d，%H:%M:%S】的说……呼呼……哈……zzZ"
            k = r"嗯呃……额……啊嗯……吃……真的吃不下了……嘿嘿……（【%Y-%m-%d，%H:%M:%S】）"
            i1 = r"【%Y-%m-%d，%H:%M:%S】？怎么回事……啊呜……不要起床……不要……"
            # 上午 08.00-11.00
            l = r"太阳……好烦……（把头埋进被子）嗯呃……（【%Y-%m-%d，%H:%M:%S】)"
            m = r"【%Y-%m-%d，%H:%M:%S】？还有点困呢，再睡一觉的说……(～￣▽￣)～"
            n = r"呼……哈……嗯嗯~？【%Y-%m-%d，%H:%M:%S】？等……等等再起床啦……"
            # 中午 11.00-13.00
            o = r"【%Y-%m-%d，%H:%M:%S】，果然还是起来早点吃早饭比较好麻……",
            p = r"早上果然就应该一股脑地睡过去的说！啊，不是……我的意思是……都【%Y-%m-%d，%H:%M:%S】了呢，大家一定要养成早睡早起的好习惯，嗯……"
            q = r"糟！？都【%Y-%m-%d，%H:%M:%S】这个时间段了，再不去吃饭就要被骂了的说……(っ°Д°;)っ"
            o1 = r"（啪哒）啊呜……（从床上滚到地板）磕到脚趾母了，脚好痛的说……（看向时钟）原来已经%Y-%m-%d，%H:%M:%S了吗……脚还是好痛的说……啊呜……"
            # 下午 13.00-16.00
            r = r"【%Y-%m-%d，%H:%M:%S】……我能做些什么呢……果然什么都做不好的样子呢……"
            s = r"下午【%Y-%m-%d，%H:%M:%S】的说……还要多久这一天才能过去呢？"
            t = r"加把劲……哦……呃嗯……果然还是提不起劲的说，好想睡觉……（【%Y-%m-%d，%H:%M:%S】）"
            # 傍晚 16.00-19.00
            u = r"【%Y-%m-%d，%H:%M:%S】……特地来问我……我也不会有什么特别的想法的说……"
            v = r"今天有没有夕阳呢？现在是(*°▽°*)【%Y-%m-%d，%H:%M:%S】的说"
            w = r"晚饭的香味？……肚子有点饿了的说……（【%Y-%m-%d，%H:%M:%S】）"
            # 晚上 19.00-00.00
            x = r"都到【%Y-%m-%d，%H:%M:%S】了，不会还有什么没有做完的事情吧……"
            y = r"【%Y-%m-%d，%H:%M:%S】的说，有点晚了呢……不知道今天夜晚的星星有多少颗呢？"
            z = r"【%Y-%m-%d，%H:%M:%S】，已经到这个时间了，总感觉晚上好兴奋呢*★,°*:.☆\(￣▽￣)/$:*.°★*"
