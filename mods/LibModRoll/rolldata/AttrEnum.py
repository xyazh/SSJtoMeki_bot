...
class AttrEnum(Enum, metaclass=AttrEnumMeta):
    ...
    MOV = (8, "MOV", "Move Rate", "移动率", "移动力", "行动力", "体力")
    ACCOUNTING = (5, "Accounting", "会计")
    ANTHROPOLOGY = (1, "Anthropology", "人类学")
    APPRAISE = (5, "Appraise", "估价")
    ARCHAEOLOGY = (1, "Archaeology", "考古学", "考古")
    ART = (5, "Art", "艺术", "技艺")
    CHARM = (15, "Charm", "魅惑", "取悦")
    CLIMB = (20, "Climb", "攀爬")
    COMPUTER_USE = (5, "Computer use", "计算机", "计算机使用", "电脑", "电脑使用")
    CREDIT_RATING = (0, "Credit Rating", "信用评级",
                     "信誉评级", "信用等级", "信誉等级", "信用", "信誉")
    CTHULHU_MYTHOS = (0, "Cthulhu Mythos", "CM", "cm", "克苏鲁神话", "克苏鲁")
    DISGUISE = (5, "Disguise", "乔装")
    DODGE = (40, "Dodge", "闪避")
    DRIVE_AUTO = (20, "Drive Auto", "汽车驾驶", "汽车")
    ELECTRICAL_REPAIR = (10, "Electrical Repair", "电气维修", "电气")
    ...
    JUMP = (20, "Jump", "跳跃")
    LANGUAGE = (1, "Language", "语言", "外语")
    LAW = (5, "Law", "法律")
    LIBRARY_USE = (20, "Library Use", "图书馆使用", "图书馆")
    LISTEN = (20, "Listen", "聆听")
    LOCKSMITH = (1, "Locksmith", "开锁", "锁匠", "撬锁")
    MECHANICAL_REPAIR = (10, "Mechanical Repair", "机械维修")
    MEDICINE = (1, "Medicine", "医学")
    NATURAL_WORLD = (10, "Natural World", "博物学", "自然学")
    NAVIGATE = (10, "Navigate", "导航", "领航")
    OCCULT = (5, "Occult", "神秘学")
    OPERATE_HEAVY_MACHINES = (
        1, "Operate Heavy Machines", "重型机械操作", "操作重型机械", "重机", "重型操作", "重型机械", "重型")
